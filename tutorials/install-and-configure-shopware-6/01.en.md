...
Shopware will need credentials to connect to the database. So next we will create an new MySQL user and a new MySQL Database. With the command `mysql` can we start a new mysql session.
